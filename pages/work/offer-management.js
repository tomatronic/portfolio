        ...
        <>
            ...
            <div className="mainContainer">
                ...
                <div className={styles.section}>
                    <h2 className="underline">Understanding the Problem</h2>
                ...
                <div className={styles.section}>
                    <div className="row">
                        <div className="column">
                            <h2 className="underline">Planning</h2>
                    ...
                    <div className="row">
                        ...
                        <div className="column">
                            <h2 className="underline">Sketching</h2>
                    ...
                    <div className="row">
                        <div className="column">
                            <h2 className="underline">Design development</h2>
                    ...
                    <div className="row">
                        ...
                        <div className="column">
                            <h2 className="underline">Developing flows</h2>
                ...
                <h2 className={`${styles.pSpacerTop} , ${['underline']}`}>Iteration</h2>
                ...
                <h2 className="underline">How did it go?</h2>
